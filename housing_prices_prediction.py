'''
In this exercise you'll try to build a neural network that predicts the price of a house
...
xs=np.array([5,1,3,4,6,2],dtype=float)
ys=np.array([3.0,1.0,2.0,2.5,3.5,1.5],dtype=float)
model.fit(xs,ys,epochs=5),
price = model.predict([7])
print(f"The price for seven bedroom house is {price}. hundred thousands")